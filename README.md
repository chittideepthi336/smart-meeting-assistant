...
[![Gemini](https://img.shields.io/badge/Gemini-1.5--flash-orange?style=flat-square)](https://ai.google.dev)
...
- `client_secrets.json` — Google OAuth 2.0 client credentials
...
meetings/
  {meeting_id}/
    ...
    calendar_events_created: boolean
    email_sent: boolean
```
